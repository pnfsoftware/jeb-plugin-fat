...
final class ShortName {
     ...
     */
    private final static byte[] ILLEGAL_CHARS = { 0x22, 0x2A, 0x2B, 0x2C, 0x2E, 0x2F, 0x3A, 0x3B, 0x3C, 0x3D, 0x3E,
     ...
     *
     * @param name
     *            the name+extension of the {@code ShortName} to get
     * @return the {@code ShortName} representing the specified name
     * @throws IllegalArgumentException
     *             if the specified name can not be parsed into a
     *             {@code ShortName}
     ...
     * @throws IllegalArgumentException
     *             if invalid chars are contained
     */
