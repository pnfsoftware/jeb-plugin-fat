...
public interface BlockDevice {
     ...
     * @throws IOException
     *             on error getting the size of this device
     */
     ...
     *
     * @param devOffset
     *            the byte offset where to read the data from
     * @param dest
     ...
     *
     * @param devOffset
     *            the byte offset where to store the data
     * @param src
     *            the source {@code ByteBuffer} to write to the device
     * @throws ReadOnlyException
     *             if this {@code BlockDevice} is read-only
     * @throws IOException
     *             on write error
     * @throws IllegalArgumentException
     *             if the {@code devOffset} is negative or the write would go
     *             beyond the end of the device
     * @see #isReadOnly()
     */
    public abstract void write(long devOffset, ByteBuffer src) throws ReadOnlyException, IOException,
     ...
     * @throws IOException
     *             on error determining the sector size
     */
     ...
     *
     * @throws IOException
     *             on error closing this device
     * @see #isClosed()
     */
    public void close() throws IOException;

    /**
     * Checks if this device was already closed. No methods may be called on a
     * closed device (except this method).
     *
